...
console.log( 'O array em formato de string é:' );
    console.log([1, 2, 4, 5, 6].toString());
...
*/
    ...
    let sudeste = ['Espírito Santo', 'Minas Gerais', 'São Paulo', 'Rio de Janeiro'];
...
console.log( '\nMais estados adicionados:' );
    brasil.unshift('Acré', 'Amazonas', 'Amapa')
    console.log(brasil);
...
*/
    let nordeste = ['Bahia', 'Alagoas', 'Ceará', 'Maranhão', 'Paraiba', 'Pernambuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe'];
/*
