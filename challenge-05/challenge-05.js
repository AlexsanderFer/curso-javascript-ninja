...
*/
// 
let qualquer = ['Alexsander', { a: 1 }, function () { }, null, 20];

/*
Crie uma função que receba um array como parâmetro, e retorne esse array.
*/
// 
function retornarArray ([qualquer]) {
    return qualquer;
}
...
*/
//
console.log(retornarArray(qualquer[1]));
...
*/
//
let myArray = ['Curso', 10.5, false, [1, 2, 3, 'Alex'], { b: 2 }];
...
*/
//
console.log(doisParametros(myArray, 0));
console.log(doisParametros(myArray, 1));
console.log(doisParametros(myArray, 2));
console.log(doisParametros(myArray, 3));
console.log(doisParametros(myArray, 4));
...
function book(bookName) {
    let allBooks = {
        'O Despertar Do Imperio': {
            quantidadePaginas: 527,
            autor: 'Sam Barone',
...
let bookName = 'O Despertar do Império';
